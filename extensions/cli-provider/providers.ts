 ...
 * | Project MCP | `--approve-mcps` if `CLI_APPROVE_MCPS` or `SIDECAR_PORT` (`startSidecar()` stamps it while running) | n/a | `GEMINI_CLI_TRUST_WORKSPACE=true` unless parent already set |
 *
