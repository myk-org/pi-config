...
describe("assertPiVersionFloor", () => {
  it("requires the installed SDK to meet the 0.87.0 floor", () => {
    ...
    assert.equal(compareVersions("0.86.9", MIN_PI_VERSION) < 0, true);
    assert.equal(compareVersions("0.87.0", MIN_PI_VERSION) >= 0, true);
